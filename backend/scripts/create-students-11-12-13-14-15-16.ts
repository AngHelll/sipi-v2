#!/usr/bin/env ts-node
/**
 * Script to create student11, student12, student13, student14, student15, and student16 users
 * 
 * Creates six additional student users for testing purposes
 * 
 * Usage: npx ts-node scripts/create-students-11-12-13-14-15-16.ts
 */
...
const studentsData: StudentData[] = [
  {
    ...
    apellidoMaterno: 'Once',
    curp: 'TSTO000000HDFRLS11',
  },
  {
    username: 'student12',
    ...
    nombre: 'Test',
    apellidoPaterno: 'Student',
    apellidoMaterno: 'Doce',
    curp: 'TSTD000000HDFRLS12',
  },
  {
    username: 'student13',
    ...
    nombre: 'Test',
    apellidoPaterno: 'Student',
    apellidoMaterno: 'Trece',
    curp: 'TSTT000000HDFRLS13',
  },
  {
    username: 'student14',
    ...
    nombre: 'Test',
    apellidoPaterno: 'Student',
    apellidoMaterno: 'Catorce',
    curp: 'TSTC000000HDFRLS14',
  },
  {
    username: 'student15',
    ...
    nombre: 'Test',
    apellidoPaterno: 'Student',
    apellidoMaterno: 'Quince',
    curp: 'TSTQ000000HDFRLS15',
  },
  {
    username: 'student16',
    ...
    nombre: 'Test',
    apellidoPaterno: 'Student',
    apellidoMaterno: 'Dieciseis',
    curp: 'TSTD000000HDFRLS16',
  },
];

async function createStudents() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log('║     👨‍🎓 CREATING STUDENTS 11, 12, 13, 14, 15, AND 16        ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
