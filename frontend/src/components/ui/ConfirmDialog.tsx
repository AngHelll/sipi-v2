...
export const ConfirmDialog = ({
  ...
  const variantStyles = {
    danger: {
      ...
      confirmButton: 'bg-error hover:opacity-90 text-on-error',
    },
    warning: {
      icon: (
      ...
      confirmButton: 'bg-secondary hover:opacity-90 text-on-secondary',
    },
    info: {
      icon: (
      ...
      confirmButton: 'bg-tertiary hover:opacity-90 text-on-tertiary',
    },
  };
          ...
          <div className="bg-surface px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className={`mx-auto flex h-12 w-12 shrink-0 items-center justify-center rounded-full sm:mx-0 sm:h-10 sm:w-10 ${
                variant === 'danger' ? 'bg-error-container' : variant === 'warning' ? 'bg-secondary-container' : 'bg-tertiary-container'
              }`}>
                {styles.icon}
              </div>
